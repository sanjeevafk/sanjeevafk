...
| **[KnowBear](https://knowbear.app)**                                | Adaptive explainer: toddler ↔ teen ↔ meme-style breakdowns with real-time search & model routing | [GitHub](https://github.com/voidcommit-afk/knowbear-v1)<br>Vite + TS · Groq ensemble · Tavily/Exa · Redis                         |
...
| **[DailyThoughts](https://daily-thoughts.vercel.app)**                     | Private, invite-only shared journaling for couples & close friends                               | [GitHub](https://github.com/voidcommit-afk/DailyThoughts)<br>Next.js + Supabase Auth + Postgres                                |
| **[Tutor Intelligence Dashboard](https://tutor-intelligence-dashboard.vercel.app/)** | AI-powered student progress tracker that surfaces weekly learning patterns and insights.         | [GitHub](https://github.com/voidcommit-afk/tutor-intelligence-dashboard)<br>TypeScript · Next.js · AI Summaries · EdTech |
