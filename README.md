...
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| **[BibleLM](https://biblelm.vercel.app)**                                  | Fast, neutral Bible chatbot with strict original-language RAG (zero theology, edge-optimized)    | [GitHub](https://github.com/sanjeevafk/BibleLM)<br>TS · Groq · Vercel Edge · Hybrid RAG                                     |
| **[KnowBear](https://knowbear.app)**                                | Adaptive explainer: toddler ↔ teen ↔ meme-style breakdowns with real-time search & model routing | [GitHub](https://github.com/sanjeevafk/knowbear-v1)<br>Vite + TS · Groq ensemble · Tavily/Exa · Redis                         |
| **AI Slop Detector**                                                       | Privacy-first local AI-image detector Chrome extension (no uploads)                              | [GitHub](https://github.com/sanjeevafk/ai-slop-detector)<br>Chrome MV3 · FastAPI · Hugging Face Transformers (CPU ensemble) |
| **[VexTube](https://vextube.vercel.app)**                                  | Distraction-free YouTube learning player with simultaneous rich Markdown notes export            | [GitHub](https://github.com/sanjeevafk/VexTube)<br>Next.js 16 · React 19 · Local                                         |
| **Sanctum**                     | Private, Self-hosted shared journaling app for couples & close friends                               | [GitHub](https://github.com/sanjeevafk/sanctum)<br>Next.js + Supabase Auth + Postgres                                |
| **[Tutor Intelligence Dashboard](https://tutor-intelligence-dashboard.vercel.app/)** | AI-powered student progress tracker that surfaces weekly learning patterns and insights.         | [GitHub](https://github.com/sanjeevafk/tutor-intelligence-dashboard)<br>TypeScript · Next.js · AI Summaries · EdTech |
...
[Portfolio](https://sanjeevkumar.me/) · [X](https://x.com/ghostdevoid) · [LinkedIn](https://linkedin.com/in/s-sanjeev-kumar) · [Email](mailto:hello@sanjeevkumar.me)
